...
@NamedQueries({
        ...
        @NamedQuery(name = "Produto.findAllByReferencia", query = "SELECT c FROM Produto c WHERE c.referencia like :referencia"),
        @NamedQuery(name = "Produto.findByNome", query = "SELECT c FROM Produto c WHERE c.nome = :nome"),
        @NamedQuery(name = "Produto.findByDescricao", query = "SELECT c FROM Produto c WHERE c.descricao = :descricao"),
        @NamedQuery(name = "Produto.findByMarca", query = "SELECT c FROM Produto c WHERE c.marca = :marca"),
        @NamedQuery(name = "Produto.findByQuantidade", query = "SELECT c FROM Produto c WHERE c.quantidade = :quantidade"),
        @NamedQuery(name = "Produto.findByPreco", query = "SELECT c FROM Produto c WHERE c.preco = :preco"),
        @NamedQuery(name = "Produto.findByIdCategoria", query = "SELECT c FROM Produto c WHERE c.categoriaByIdcategoria = :categoriaByIdcategoria"),
        @NamedQuery(name = "Produto.findByIva", query = "SELECT c FROM Produto c WHERE c.iva = :iva"),
        @NamedQuery(name = "Produto.findByPrecoIva", query = "SELECT c FROM Produto c WHERE c.precoIva = :precoIva")})
