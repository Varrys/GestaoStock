...
@Entity
@Table(name = "ESTADOENCOMENDA")
@XmlRootElement
@NamedQueries({
        @NamedQuery(name = "Estadoencomenda.findAll", query = "SELECT c FROM Estadoencomenda c"),
        @NamedQuery(name = "Estadoencomenda.findAllByIdEstado", query = "SELECT c FROM Estadoencomenda c WHERE c.idestado like :idestado"),
        @NamedQuery(name = "Estadoencomenda.findByEstado", query = "SELECT c FROM Estadoencomenda c WHERE c.estado = :estado")})
